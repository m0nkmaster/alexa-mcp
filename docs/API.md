...
| Region        | Login domain   | EU/App API base (primary)        | Evidence   |
|---------------|----------------|-----------------------------------|------------|
| **UK**        | amazon.co.uk   | `https://eu-api-alexa.amazon.co.uk` | HAR (all)  |
| **EU (DE)**   | amazon.de      | `https://eu-api-alexa.amazon.de`    | Config     |
| **US/Global** | amazon.com     | *TBC* — likely `pitangui.amazon.com` or regional equivalent; capture HAR with amazon.com account to confirm. | —          |
